...
namespace Yooocan.Web.Utils
{
    public class GoogleAnalyticsLogic : IGoogleAnalyticsLogic
    {
        ...
        public GoogleAnalyticsLogic(ILogger<GoogleAnalyticsLogic> logger, IActionContextAccessor actionContextAccessor, string resourceId = "UA-80047159-1")
        {
        ...
        private void Track(HitType type, string userId, string category = null, string action = null, string label = null, int? value = null, string path = null)
        {
            try
            {
                ...
                httpClient.DefaultRequestHeaders.Add("User-Agent", "YoocanServer");
