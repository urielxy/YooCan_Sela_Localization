...
namespace Alto.Web.Migrations
{
    ...
    [Migration("20170207204958_ShippingChangesMig")]
    partial class ShippingChangesMig
    {
            ...
            modelBuilder.Entity("Alto.Domain.AltoUser", b =>
                {
                    ...
                    b.Property<int?>("ReferralPromoId");
            ...
            modelBuilder.Entity("Alto.Domain.AltoUser", b =>
                {
                    ...
                    b.HasOne("Alto.Domain.RegistrationPromo", "ReferralPromo")
                        .WithMany()
                        .HasForeignKey("ReferralPromoId");
                });
