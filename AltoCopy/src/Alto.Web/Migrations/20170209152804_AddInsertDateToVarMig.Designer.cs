...
namespace Alto.Web.Migrations
{
    ...
    [Migration("20170209152804_AddInsertDateToVarMig")]
    partial class AddInsertDateToVarMig
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Alto.Domain.RegistrationPromo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Alto.Domain.AltoUser", b =>
                {
                    ...
                    b.HasOne("Alto.Domain.RegistrationPromo", "ReferrerPromo")
                        .WithMany()
